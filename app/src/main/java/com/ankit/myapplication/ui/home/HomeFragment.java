package com.ankit.myapplication.ui.home;
...
import com.ankit.myapplication.ArticleAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        someHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                textClock.setText(new SimpleDateFormat("hh:mm a", Locale.getDefault()).format(new Date()));
        ...
        layoutManager = new LinearLayoutManager(HomeFragment.super.getContext(), LinearLayoutManager.VERTICAL, false);
        listItem.setLayoutManager(layoutManager);
        articleAdapter = new ArticleAdapter(super.getActivity(), articles);
    ...
    private void initializeUI(View root) {
        listItem = root.findViewById(R.id.article_list);
